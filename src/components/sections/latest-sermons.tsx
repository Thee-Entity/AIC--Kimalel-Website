    ...
    <section className="py-20">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-4 justify-center">
            <Input placeholder="Search sermons..." className="max-w-sm bg-gray-800 border-gray-700 text-white focus:ring-accent" />
            <Select>
                <SelectTrigger className="w-full md:w-[180px] bg-gray-800 border-gray-700 text-white focus:ring-accent">
            ...
            return (
              <Card key={index} className="overflow-hidden group bg-gray-800/50 border-accent/20 border backdrop-blur-sm text-white transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:shadow-accent/20">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-400 mb-4">{sermon.speaker} &bull; {sermon.date.toLocaleDateString()}</p>
                  <p className="text-gray-300 text-sm mb-4 h-20 overflow-hidden">{sermon.summary}</p>
