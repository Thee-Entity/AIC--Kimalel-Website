    ...
    <section className="py-20 bg-background">
        ...
        <div className="container mx-auto px-4">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold font-headline text-primary mb-4">Impact of Your Giving</h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {impactItems.map(item => (
                    <Card key={item.text} className="bg-card border-accent/20 border backdrop-blur-sm text-center p-6 group transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:shadow-accent/20">
