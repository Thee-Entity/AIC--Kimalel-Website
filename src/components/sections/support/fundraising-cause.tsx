    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-headline text-primary mb-4">Why We Are Raising Funds</h2>
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <Progress value={44} className="h-4 bg-muted border border-accent/30 [&>div]:bg-accent" />
             <div className="text-center mt-4 text-muted-foreground">44% of goal raised</div>
        </div>
      </div>
    </section>
  );
