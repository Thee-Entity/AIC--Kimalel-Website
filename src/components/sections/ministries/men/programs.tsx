...
import { BookOpen, Users, Globe, Mic } from "lucide-react";

export default function MensFellowshipPrograms() {
  const programs = [
    { title: "Bible Studies", icon: BookOpen },
    { title: "Mentorship & Discipleship", icon: Users },
    { title: "Community Service & Outreach", icon: Globe },
    { title: "Men’s Conferences & Retreats", icon: Mic },
  ];
