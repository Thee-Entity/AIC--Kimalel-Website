...
export default function MensFellowshipAbout() {
    const pillars = [
        { name: "Faith", icon: ShieldCheck },
    ...
    <section className="py-20 bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-300 mb-12">
          “Raising men who lead with integrity, courage, and wisdom from God.”
        </p>
        <div className="section-divider my-12"></div>
        <h3 className="text-2xl font-bold font-headline text-white mb-8">Our Pillars</h3>
