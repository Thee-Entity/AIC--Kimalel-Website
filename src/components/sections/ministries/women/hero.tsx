...
const heroSlides = [
  PlaceHolderImages.find(p => p.id === 'ministry-women-hero'),
  PlaceHolderImages.find(p => p.id === 'ministry-women-highlight'),
].filter(Boolean) as (typeof PlaceHolderImages)[0][];

export default function WomensFellowshipHero() {
