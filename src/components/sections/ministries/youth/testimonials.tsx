...
const youthTestimonies = testimonies.filter(t => t.name.includes("Tabitha") || t.name.includes("Brian"));

export default function YouthFellowshipTestimonials() {
  return (
    <section className="py-20">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <CarouselContent>
            {youthTestimonies.map((testimonial, index) => {
