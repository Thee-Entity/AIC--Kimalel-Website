import { Flame, Users, HeartHandshake } from "lucide-react";

export default function YouthFellowshipAbout() {
    const pillars = [
        { name: "Worship", icon: Flame },
        { name: "Fellowship", icon: Users },
    ...
    <section className="py-20 bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-300 mb-12">
          "To raise a generation of young people who are passionate for Christ, grounded in the Word, and making a difference in the world."
        </p>
